    ...
    <footer className="text-gray-600 body-font">
        ...
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round"
                 ...
                 className="w-10 h-10 text-white p-2 bg-secondary-500 rounded-full" viewBox="0 0 24 24">
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">&copy; {(new Date()).getFullYear()} {import.meta.env.VITE_APP_NAME} —
            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1"
               target="_blank">@{import.meta.env.VITE_APP_DEVELOPER}</a>
          </p>
